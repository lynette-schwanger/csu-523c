...
nrow(states)    # should be 48. It's actually 49 because of the district of columbia
...
ft_table_five <- border_zone |>
  st_drop_geometry() |>
  summarize(cities_in_zone = n(), population_in_zone = sum(population), percent_of_total = (population_in_zone / total_pop) * 100) 
```
